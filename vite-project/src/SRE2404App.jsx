...
export default function SRE2404App() {
  ...
  width: { size: 10445, type: WidthType.DXA },
  layout: TableLayoutType.FIXED,
  // Fijo anchos de columnas: izquierda 8251 DXA + derecha (12.PAG) 2194 DXA = 10445 DXA
  columnWidths: [8251, 2194],
  borders: noBorders,
  rows: [
    new TableRow({
      height: { value: 300, rule: HeightRule.AT_LEAST },
      children: [
        // Celda izquierda (SRE 2404 / RFD-21-01-III)
        new TableCell({
          borders: {
        ...
        // Celda derecha — 12. PAG — ancho exacto 3,87 cm (2194 DXA)
        new TableCell({
          width: { size: 2194, type: WidthType.DXA }, // 👈 explícito en la celda
          ...tightCell,
          borders: {
            top: { style: BorderStyle.SINGLE, size: borderSizeThick },
            right: { style: BorderStyle.SINGLE, size: borderSizeThick },
    ...
    const doc = new Document({
      sections: [{
        ...
        children: [
          ...
          // --- REVERSO ---
          new Paragraph({ children: [tnr("SRE 2404", { size: 20, bold: true })], spacing: { after: 300 } }),
