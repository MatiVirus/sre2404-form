...
function IdentificacionActividad({ form, update }) {
  return (
    <div className="mt-4 grid grid-cols-1 md:grid-cols-4 gap-3 md:gap-4">
      ...
      {/* MODIFICADO: Campo NNE ahora es input de texto */}
      <label>
        <div className={labelCls}>NNE</div>
        <div className="flex items-center min-w-0">
          <input className={`${baseInput} uppercase flex-1 min-w-0`} placeholder="Escriba NNE" value={form.nne} onChange={(e) => update("nne", e.target.value)} />
          <ClearButton onClick={() => update("nne", "")} />
        </div>
      </label>
      
      {/* MODIFICADO: Campo INE ahora es input de texto */}
      <label>
        <div className={labelCls}>INE</div>
        <div className="flex items-center min-w-0">
          <input className={`${baseInput} uppercase flex-1 min-w-0`} placeholder="Escriba INE" value={form.ine} onChange={(e) => update("ine", e.target.value)} />
          <ClearButton onClick={() => update("ine", "")} />
        </div>
      </label>
      ...
      {/* MODIFICADO: Campo Actividad ahora es input de texto */}
      <label>
        <div className={labelCls}>Actividad</div>
        <div className="flex items-center min-w-0">
          <input className={`${baseInput} uppercase flex-1 min-w-0`} placeholder="Escriba Actividad" value={form.actividad} onChange={(e) => update("actividad", e.target.value)} />
          <ClearButton onClick={() => update("actividad", "")} />
        </div>
      </label>
...
export default function SRE2404App() {
  ...
  const [form, setForm] = useState({
    ...
    subunidad: "",
    unidad: "CGE",
    nne: "", // Vaciado para escritura libre
    ine: "", // Vaciado para escritura libre
    ni: "",
    nroSerie: "",
    nroMotor: "",
    kmMs: "",
    dispAcc: "",
    actividad: "", // Vaciado para escritura libre
    pubRefRt: "",
    pubRefRt2: "",
    pubRefGl: "",
    otras: "",
